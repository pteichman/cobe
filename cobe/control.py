...
commands.InstawebCommand.add_subparser(subparsers)
commands.InstawebAddUserCommand.add_subparser(subparsers)
commands.IrcClientCommand.add_subparser(subparsers)
commands.LearnCommand.add_subparser(subparsers)
commands.LearnIrcCorpusCommand.add_subparser(subparsers)
